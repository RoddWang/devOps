...
public class JenkinsClientImpl implements JenkinsClient {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(JenkinsClientImpl.class);

    private final URL endpoint;
    private final HttpRestClient client;

    @Inject
	protected JenkinsClientImpl(HttpRestClient client, @JenkinsUrl URL endpoint) {
