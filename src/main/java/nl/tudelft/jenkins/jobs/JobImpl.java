...
public class JobImpl implements Job {
    ...
    private static final String XPATH_PROPERTIES_SECURITY = "//project/properties/hudson.security.AuthorizationMatrixProperty";
    private static final String XPATH_NOTIFICATION_RECIPIENTS = "//project/reporters/hudson.maven.reporters.MavenMailer/recipients";
    private static final String XPATH_SCM_GIT_URL = "//project/scm/userRemoteConfigs/hudson.plugins.git.UserRemoteConfig/url";
