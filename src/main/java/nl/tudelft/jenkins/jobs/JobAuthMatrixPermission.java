...
public enum JobAuthMatrixPermission {
    ...
    public static JobAuthMatrixPermission fromText(String permissionText) {
        ...
        } else if ("hudson.model.Item.Configure".equals(permissionText)) {
            return JOB_CONFIGURE;
        } else if ("hudson.model.Item.Read".equals(permissionText) ){
            return JOB_READ;
        } else if ("hudson.model.Item.Discover".equals(permissionText)){
            return JOB_DISCOVER;
        } else if ("hudson.model.Item.Build".equals(permissionText)){
            return JOB_BUILD;
        } else if ("hudson.model.Item.Workspace".equals(permissionText)){
            return JOB_WORKSPACE;
        } else if ("hudson.model.Item.Cancel".equals(permissionText)){
            return JOB_CANCEL;
        } else if ("hudson.model.Run.Delete".equals(permissionText)){
            return RUN_DELETE;
        } else if ("hudson.model.Run.Update".equals(permissionText)){
            return RUN_UPDATE;
        } else if ("hudson.scm.SCM.Tag".equals(permissionText)){
            return SCM_TAG;
        } else{
